<?php
	...
	// http://www.vhplab.net/editor/exec/walker.php?project_id=96
	// http://www.vhplab.net/editor/exec/walker.php?project_id=96&stored=true
	// http://www.vhplab.net/editor/exec/walker.php?author_id=1
	// http://www.vhplab.net/editor/exec/walker.php?author_id=1&stored=true
	// http://www.vhplab.net/editor/exec/walker.php?&last=true
	// http://www.vhplab.net/editor/exec/walker.php?&stored=true
	...
	if (isset($author_id)) {
						...
						if (!$walkers['error']) {
							...
							foreach ($walkers_array as $single_walker) {
								...
								foreach ($single_walker_data as $position) {
									...
									$new_single_walker_data .= $dif['x'].",".$dif['y'].",".$position_data[2].";";
								}
		...
		$error = return_array('exec_read', '', $write['data_mising'], '', true, 10, "Mising variables: \$_GET['project_id'] = '".$_GET['project_id']."'.", 'exec_read');
		// print_r($error);
